...
* Proportion of station entrances/exits without vending allow entrance is `r filter(transit_df, entry == "TRUE", vending == "NO") %>% distinct(line, station_name, entry, vending) %>% count()/filter(transit_df, vending == "NO") %>% distinct(line, station_name, entry, vending) %>% count()`.
